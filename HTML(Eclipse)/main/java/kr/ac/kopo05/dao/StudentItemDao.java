...
public interface StudentItemDao {
	...
	int page_studentID(int studentID, int countPerPage) throws ClassNotFoundException, SQLException ;
	
	int countvisitDB() throws ClassNotFoundException, SQLException;
//	update
