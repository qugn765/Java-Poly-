...
%>
	<form method="post" name="form">
		<h1 style="height: 50px">성적 조회후 정정 / 삭제</h1>
		<br>
		<br> 조회할 학번 <input type="number" style="width: 300px;"
			style="height: 20px;" value="<%=student_id%>"> <input
			type="submit" value="조회" style="width: 100px; height: 25px;">
		<table border=1 style="width: 500px;">
			<tr>
				<td style="width: 100px">이름</td>
				<td style="width: 400px"><input type="text" name="name"
					value=<%=st.getName()%> style="width: 300px"></td>
			</tr>
			<tr>
				<td style="width: 100px">학번</td>
				<td style="width: 400px"><input readonly type="text"
					name="studentid" readonly value=<%=st.getStudentid()%>
					style="width: 300px"></td>
			</tr>
			<tr>
				<td style="width: 100px">국어</td>
				<td style="width: 400px"><input type="number" name="kor"
					value=<%=st.getKor()%> style="width: 300px"></td>
			</tr>
			<tr>
				<td style="width: 100px">영어</td>
				<td style="width: 400px"><input type="number" name="eng"
					value=<%=st.getEng()%> style="width: 300px"></td>
			</tr>
			<tr>
				<td style="width: 100px">수학</td>
				<td style="width: 400px"><input type="number" name="mat"
					value=<%=st.getMat()%> style="width: 300px"></td>
			</tr>
		</table>
		<div style="text-align: right; width: 500px">
			<input type="submit" value="수정"
				onclick="javascript: form.action='updateDB.jsp';" /> <input
