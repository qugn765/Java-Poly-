...
try{
	...
	StudentItemDao studentItemDao2 = new StudentItemDaoImpl();
	now_page = studentItemDao2.page_studentID(studentID, countPerPage);
}
%>
</HEAD>
<BODY>
	...
	<table width='100%' border=1>
		...
		if(studentID == studentItemList.get(i).getStudentid()){
		%>
	...
	<div style="text-align: center">
		...
		%>
		<a
			href="updateDBAllview.jsp?page=<%=pagination.getPp()%>&cnt=<%=countPerPage%>&studentID=<%=studentID%>">&lt;&lt;</a>
		<a
			href="updateDBAllview.jsp?page=<%=pagination.getP()%>&cnt=<%=countPerPage%>&studentID=<%=studentID%>">&lt;</a>
...
%>
		...
		%>
		<a href="updateDBAllview.jsp?page=<%=(i)%>&cnt=<%=countPerPage%>&studentID=<%=studentID%>"><%=i%></a>
		<%
		...
		%>
		<a
			href="updateDBAllview.jsp?page=<%=(pagination.getN())%>&cnt=<%=countPerPage%>&studentID=<%=studentID%>">&gt;</a>
		<a
			href="updateDBAllview.jsp?page=<%=pagination.getNn()%>&cnt=<%=countPerPage%>&studentID=<%=studentID%>">&gt;&gt;</a>
		<%
