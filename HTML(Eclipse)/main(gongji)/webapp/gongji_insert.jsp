...
<form method="post" action="gongji_write.jsp">
	<table border=1>
		...
		<tr>
			...
			<td width="550px">신규(insert) : <%=gongjiDao.maxId() + 1%>번
			<input type="hidden" name="id" value="<%=gongjiDao.maxId() + 1%>">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><%=service.nowTime()%>
			<input type="hidden" name="date" value="<%=service.nowTime()%>"></td>
		</tr>
		<tr style="height: 400px">
			<td style="text-align: center">내용</td>
			<td><textarea style="height: 400px; width: 550px" name="content"></textarea></td>
		</tr>
	</table>
	<table>
		<tr>
			<td style="text-align: right"><a href="./gongji_list.jsp"> <input
					type="button" value="취소"></a>&nbsp; <input
