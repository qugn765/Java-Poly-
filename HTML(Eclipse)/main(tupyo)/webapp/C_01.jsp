...
<BODY>
	<div style="text-align: center">
		<a href="./A_01.jsp"> <input type="button" value="후보등록"
			...
			<input type="button" value="투표" style="width: 20%; height: 50px">
	...
	<table width="60%" align=center border=1>
		...
		%>
		<tr>
			<td width = "15%"><a href = "./C_02.jsp?number=<%=h.getNumber()%>"><%=s%></a></td>
			<td><img src = "bar.PNG" width = "<%=rate * 80 / 100%>%" height = 25px><%=rate%>%(<%=agerate.getCount()%>표)</td>
		</tr>
		<%
		}
		%>
