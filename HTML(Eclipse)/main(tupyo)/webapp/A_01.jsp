...
<body>
	<div style="text-align: center">
		<a href="./A_01.jsp"> <input type="button" value="후보등록"
			style="width: 20%; height: 50px; background-color: yellow"></a> <a
	...
	<table style="width: 60%" border=1 align=center>
		...
		int number_x = tupyo.searchNumber();
			...
			<td>
				<div style="display: flex">
					...
					<div style="width: 100px">
						<a href="./A_02.jsp?number=<%=number%>&name=<%=name%>"> <input
							type="submit" value="삭제" style="text-align: right"></a>
					</div>
				</div>
			</td>
		</tr>
		...
		<form action="A_03.jsp" method="get">
			<tr>
				<td><div style="display: flex">
						<div style="width: 45%">
							기호번호 : <input type="number" readonly name="number"
								style="width: 40%" value="<%=number_x%>">
						</div>
						<div style="width: 45%">
							후보명 : <input type="text" name="name" required style="width: 40%"
								maxlength="10">
						</div>
