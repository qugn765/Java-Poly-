...
<BODY>
	<div style="text-align: center">
		<a href="./A_01.jsp"> <input type="button" value="후보등록"
			style="width: 20%; height: 50px"></a> <a href="./B_01.jsp">
			<input type="button" value="투표" style="width: 20%; height: 50px; background-color:yellow">
		</a> <a href="./C_01.jsp"> <input type="button" value="개표결과"
			style="width: 20%; height: 50px"></a>
	</div>
	...
	if(huboList.size() < 1) {
		out.println("<h2 style='text-align:center'>투표할 후보가 없습니다.</h2>");
	} else {
	%>
		<tr>
			<td colspan="2">
			...
			<select name = "hubo" id ="hubo" style="width:45%; text-align:center">
			<%
			for(hubo h : huboList){
				String s = "기호" + h.getNumber()+ "번 :  " + h.getName();
			%>
			...
			<select name = "age" id="age" style="width:45%; text-align:center">
