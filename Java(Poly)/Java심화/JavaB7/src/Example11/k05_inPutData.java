...
public class k05_inPutData {
	...
	ArrayList<Integer>k05_numarr = new ArrayList<Integer>();
	ArrayList<String>k05_namearr = new ArrayList<String>();
	ArrayList<Integer>k05_korarr = new ArrayList<Integer>();
	ArrayList<Integer>k05_engarr = new ArrayList<Integer>();
	ArrayList<Integer>k05_matharr = new ArrayList<Integer>();
	ArrayList<Integer>k05_sumarr = new ArrayList<Integer>();
	ArrayList<Double>k05_avgarr = new ArrayList<Double>();
	...
	public void k05_SetData(int k05_a, String k05_s, int k05_b, int k05_c, int k05_d) {
		...
		k05_numarr.add(k05_a);
		k05_namearr.add(k05_s);
		k05_korarr.add(k05_b);
		k05_engarr.add(k05_c);
		k05_matharr.add(k05_d);
		k05_sumarr.add(k05_sum);
		k05_avgarr.add(k05_avg); // 이름 점수를 입력받아서 배열에 저장하고 합계와 평균을 구해서 배열에 저장
	}	
	...
	public void k05_printData(int k05_iPerson) {
		...
		for (int k05_i = 0; k05_i < k05_iPerson; k05_i++) {
			...
			System.out.printf("%04d  %5.5s         %4.4s      %4.4s      %4.4s      %4.4s    %6.6s\n",
					k05_i, k05_namearr.get(k05_i), k05_korarr.get(k05_i), k05_engarr.get(k05_i), k05_matharr.get(k05_i), 
					k05_sumarr.get(k05_i), k05_avgarr.get(k05_i)); //번호에맞는 이름 국어 영어 수학점수 총점 평균 출력
			
			k05_korsum30 = k05_korsum30 + k05_korarr.get(k05_i);	
			k05_engsum30 = k05_engsum30 + k05_engarr.get(k05_i);
			k05_mathsum30 = k05_mathsum30 + k05_matharr.get(k05_i);
